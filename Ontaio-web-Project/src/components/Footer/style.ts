...
const fStyle = {
  ...
  footerCon: {
    ...
    // backgroundImage:"linear-gradient(180deg, #F87100 0%, #f2295b 100%)",
    // backgroundImage:"linear-gradient(rgb(32 53 126) 20%, rgb(82 154 196 / 64%) 100%) ",
    //backgroundImage:"linear-gradient(rgb(111 132 207) 0%, rgb(82 154 196 / 64%) 100%)",
     backgroundImage:"linear-gradient(rgb(32 53 126) 20%, rgb(82 154 196 / 64%) 100%)",
    pt: { xs: "1rem", md: "4rem" },
    pb: { xs: "1rem", md: "1rem" },
  },
  ...
  bottomLink: {
    px: { xs: "2rem", sm: "0.25rem", md: "0.5rem", lg: "0rem" },
  },
};
